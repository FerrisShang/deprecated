...
#define APP_MY_VCARD_PATH "/usr/data/my_vcard.vcf"
#define APP_YOUR_VCARD_PATH "/usr/data/"

#define APP_XML_REM_DEVICES_FILE_PATH       "/usr/data/bt_devices.xml"
 ...
 **
 ** Description      Example of function to sttop OPP Client application
 **
 ** Parameters      void
 **
 ** Returns          BSA_SUCCESS success error code for failure
