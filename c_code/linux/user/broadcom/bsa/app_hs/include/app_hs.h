...
int app_hs_get_bluetooth_call_state(void);
...
extern int app_hs_open_device0(BD_ADDR *bd_addr_in /*= NULL*/);
extern int app_xml_find_last_device_info(bd_last_info *bd_last_info);
#ifdef  __cplusplus
}
#endif
