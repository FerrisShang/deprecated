...
# Pulseaudio-5, Pulseaudio-10, ofono-1.18
...
PULSEAUDIO_10_0_NAME="pulseaudio-10.0.tar.xz"
PULSEAUDIO_10_0_URL="http://freedesktop.org/software/pulseaudio/releases/pulseaudio-10.0.tar.xz"

LIBJSON_NAME="json-c-0.11-20130402.tar.gz"
...
TINY_ALSA_NAME="tinyalsa-1.1.0.tar.gz"
TINY_ALSA_URL="https://github.com/tinyalsa/tinyalsa/archive/1.1.0.tar.gz"
...
CheckPackage $PULSEAUDIO_10_0_NAME    $PULSEAUDIO_10_0_URL
...
CheckPackage $TINY_ALSA_NAME          $TINY_ALSA_URL
