...
//extern "l3sbt.c"
extern void sbt_mono_L3(float *sample, void *pcm, int ch);
extern void sbt_dual_L3(float *sample, void *pcm, int ch);
extern void sbt16_mono_L3(float *sample, void *pcm, int ch);
extern void sbt16_dual_L3(float *sample, void *pcm, int ch);
extern void sbt8_mono_L3(float *sample, void *pcm, int ch);
extern void sbt8_dual_L3(float *sample, void *pcm, int ch);
extern void sbtB_mono_L3(float *sample, void *pcm, int ch);
extern void sbtB_dual_L3(float *sample, void *pcm, int ch);
extern void sbtB16_mono_L3(float *sample, void *pcm, int ch);
extern void sbtB16_dual_L3(float *sample, void *pcm, int ch);
extern void sbtB8_mono_L3(float *sample, void *pcm, int ch);
extern void sbtB8_dual_L3(float *sample, void *pcm, int ch);
...
{
	{
		{sbt_mono_L3, sbt_dual_L3},
		{sbt16_mono_L3, sbt16_dual_L3},
		{sbt8_mono_L3, sbt8_dual_L3},
	},
	// 8 bit output
	{
		{sbtB_mono_L3, sbtB_dual_L3},
		{sbtB16_mono_L3, sbtB16_dual_L3},
		{sbtB8_mono_L3, sbtB8_dual_L3},
	}
};
